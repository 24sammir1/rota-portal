// Run this script once to set up the database and create an admin user
...
async function setup() {
  ...
  if (existing.rows.length === 0) {
    ...
    await db.execute({
      sql: "INSERT INTO users (username, password, name, role, approved) VALUES ('admin', ?, 'Administrator', 'admin', 1)",
      args: [hashedPassword],
    });
